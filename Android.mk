...
ifneq ($(TW_AFFINITY_ENC_ONLY_AES_CORES),)
    LOCAL_CFLAGS += -DTW_AFFINITY_ENC_ONLY_AES_CORES=\"$(TW_AFFINITY_ENC_ONLY_AES_CORES)\"
endif
ifneq ($(TW_AFFINITY_ENC_AND_COMP_AES_CORES),)
    LOCAL_CFLAGS += -DTW_AFFINITY_ENC_AND_COMP_AES_CORES=\"$(TW_AFFINITY_ENC_AND_COMP_AES_CORES)\"
endif
...
# Optional: unset -> auto-detected prime core.
ifneq ($(TW_AFFINITY_GUI_TOUCH_BOOST_CORE),)
    LOCAL_CFLAGS += -DTW_AFFINITY_GUI_TOUCH_BOOST_CORE=$(TW_AFFINITY_GUI_TOUCH_BOOST_CORE)
endif
